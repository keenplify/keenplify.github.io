            ...
            <motion.div
                ...
                <motion.div 
                    ...
                    <motion.div as={Content}  variants={ParentVariants} transition={ChildrenTransitions} className="col-md-5 my-auto">
                        ...
                        <SocLink href="https://youtube.com/keenplify" target="_blank" rel="noreferrer" variants={ChildrenVariants} transition={ChildrenTransitions}>
                            <SocMed 
                                src="https://www.shareicon.net/data/256x256/2015/08/29/92756_play_607x607.png"
                                alt="Youtube social"/>
                                (Youtube) Keenplify
                        </SocLink>
                        <SocLink href="https://www.freecodecamp.org/keenplify" target="_blank" rel="noreferrer" variants={ChildrenVariants} transition={ChildrenTransitions}>
                            <SocMed 
                                src="https://i.ibb.co/X42HYpj/fcc512.png"
                                alt="Freecodecamp social"/>
                                (FreeCodeCamp) Keenplify
                        </SocLink>
                        <SocLink href="https://gamebanana.com/members/1558446" target="_blank" rel="noreferrer" variants={ChildrenVariants} transition={ChildrenTransitions}>
                            <SocMed 
                ...
                <motion.div 
                    ...
                    md={12}
                >
                    <Content className="col" variants={ParentVariants} transition={{duration: .5}}>
                        <h1 variants={ChildrenVariants} transition= {ChildrenTransitions}>LANGUAGE EXPERTISE LEVELS</h1>
                        <p variants={ChildrenVariants} transition={ChildrenTransitions}>(by year as percentage, the higher the better)</p>
                        <motion.div variants={ChildrenVariants} transition={ChildrenTransitions}>
                            <Bar
